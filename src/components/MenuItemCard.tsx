  ...
  return (
    ...
    >
      <div style={{position: "relative",}}>
        {!props.coffee.isAvailable&&<div style={{position:"absolute", right: "3px", top:"3px", color:"white"}}>Unavailable</div>}
      <img
        src={imageUrl}
        alt={name}
        style={{ width: "100%", height: "200px",zIndex: "1", objectFit: "cover" }}
      />
      </div>
